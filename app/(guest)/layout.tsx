...
const contacts = [
  ...
  {
    title: 'Email',
    description: 'benjaminkamau@demo.demo',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="32"
    ...
    <Layout>
      <div className="mx-auto grid max-w-screen-xl gap-10 py-10">
        ...
        <div className="relative">
          ...
          <div className="flex">
            <div className="flex w-1/3 flex-col items-center rounded-3xl bg-white pb-12 dark:bg-gray-800">
              <Image
              ...
              <div className="flex w-full flex-col items-center gap-5 px-5">
                ...
                <div className="flex flex-col gap-6 rounded-3xl bg-gray-100 p-10 dark:divide-gray-700 dark:bg-gray-900">
                  <ul className="flex w-full flex-col gap-6">
                    {contacts.map((contact, index) => (
                      <li
                        key={index}
                        className="border-b-2 pb-6 dark:border-gray-700"
                      >
