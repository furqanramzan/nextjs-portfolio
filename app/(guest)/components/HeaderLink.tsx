...
export default function HeaderLink({ link }: Props) {
  ...
  return (
    <Link href={link.href}>
      <div
        className={`flex h-20 w-20 flex-col items-center justify-center gap-1 rounded-3xl bg-gray-200 hover:shadow-lg focus:ring-primary-300 dark:bg-gray-900 dark:text-white dark:focus:ring-primary-800 md:h-24 md:w-24 ${
          isCurrentLinkActive &&
